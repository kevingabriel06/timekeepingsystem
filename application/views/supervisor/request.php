            ...
            <div class=" col-xl-3 col-lg-4 col-md-12 theiaStickySidebar">
                <aside class="sidebar sidebar-user">
                    ...
                    <div class="card shadow-sm ctm-border-radius">
                        <div class="card-body">
                            <span class="avatar" data-toggle="tooltip" data-placement="top" title="Jenni Sims"><img src="assets/img/profiles/img-3.jpg" alt="Jenni Sims" class="img-fluid"></span><span class="ml-4">Jenni Sims is working from home today.</span>
                        </div>
                    </div>
                    <div class="card shadow-sm ctm-border-radius">
                        <div class="card-body">
                            <span class="avatar" data-toggle="tooltip" data-placement="top" title="John Gibbs"><img class="img-fluid" src="assets/img/profiles/img-2.jpg" alt="Jenni Sims"></span><span class="ml-4">
